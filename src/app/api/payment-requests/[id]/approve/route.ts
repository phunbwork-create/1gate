...
// Approval chain: Accountant only
const APPROVAL_CHAIN = ["Accountant"] as const
...
export async function POST(
  ...
  const result = await requireRole("Accountant", "Admin")
  ...
  try {
    ...
    await notifyWorkflow({
      ...
      comment,
      recipients: [request.createdBy].map((u) => ({
    ...
    console.error("POST /api/payment-requests/[id]/approve error:", error)
    return serverError()
  }
}
